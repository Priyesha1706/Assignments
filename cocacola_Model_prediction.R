...
library(smooth)
library(readxl)
cocacola_dataset <- read_excel("C:\\Users\\nitin\\Desktop\\priyesha assignment\\FORCASTING\\CocaCola_Sales_Rawdata.xlsx")
View(cocacola_dataset)
plot(cocacola_dataset$Sales,type = "o")
Q1 <-  ifelse(grepl("Q1",cocacola_dataset$Quarter),'1','0')
Q2 <-  ifelse(grepl("Q2",cocacola_dataset$Quarter),'1','0')
Q3 <-  ifelse(grepl("Q3",cocacola_dataset$Quarter),'1','0')
Q4 <-  ifelse(grepl("Q4",cocacola_dataset$Quarter),'1','0')
# So creating  dummy variables 

CocacolaData<-cbind(cocacola_dataset,Q1,Q2,Q3,Q4)
View(CocacolaData)
